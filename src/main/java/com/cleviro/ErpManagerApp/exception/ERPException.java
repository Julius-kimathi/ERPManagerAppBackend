...
import com.cleviro.ErpManagerApp.config.PropertiesConfig;
...
public class ERPException {
    ...
    @Autowired
    public ERPException(PropertiesConfig propertiesConfig) {
        ERPException.propertiesConfig = propertiesConfig;
    }
